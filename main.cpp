...
int main(int argc, char **argv) {
  ...
  // Icon
  HICON LoadedIcon = LoadIcon(wc.hInstance, MAKEINTRESOURCE(IDI_ICON));
  wc.hIcon = LoadedIcon;
  wc.hIconSm = LoadedIcon;
  
  ::RegisterClassExW(&wc);
  HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Nikon Scan 5.0", WS_OVERLAPPEDWINDOW,
