...
#pragma clang diagnostic ignored "-Wint-to-void-pointer-cast" // warning: cast to 'void *' from
...
#pragma GCC diagnostic ignored "-Wint-to-pointer-cast" // warning: cast to pointer from
...
#pragma GCC diagnostic ignored "-Wconversion"       // warning: conversion to 'xxxx' from 'xxxx'
                                                    // may alter its value
#pragma GCC diagnostic ignored "-Wmisleading-indentation" // [__GNUC__ >= 6] warning: this 'if'
                                                          // clause does not guard this statement //
...
void ImGui::ShowDemoWindow(bool *p_open) {
  ...
  if (show_app_dockspace)
    ShowExampleAppDockSpace(&show_app_dockspace); // Process the Docking app first, as explicit
                                                  // DockSpace() nodes needs to be submitted early
                                                  // (read comments near the DockSpace function)
  if (show_app_documents)
    ShowExampleAppDocuments(&show_app_documents); // Process the Document app next, as it
                                                  // may also use a DockSpace()
  if (show_app_console)
  ...
  if (ImGui::CollapsingHeader("Configuration")) {
    ...
    if (ImGui::TreeNode("Configuration##2")) {
      ...
      if (io.ConfigDockingWithShift)
        HelpMarker("Drag from window title bar or their tab to dock/undock. Hold "
      ...
      ImGui::SameLine();
      HelpMarker("Enable input queue trickling: some types of events submitted during "
      ...
      ImGui::SameLine();
      HelpMarker("Instruct Dear ImGui to render a mouse cursor itself. Note that a "
    ...
    if (ImGui::TreeNode("Capture/Logging")) {
      HelpMarker("The logging API redirects all text output so you can easily capture "
                 "the content of "
...
static void ShowDemoWindowWidgets() {
  ...
  if (ImGui::TreeNode("Images")) {
    ...
    float my_tex_h = (float)io.Fonts->TexHeight;
    {
      ...
      if (ImGui::IsItemHovered() && ImGui::BeginTooltip()) {
        ...
        ImGui::Image(my_tex_id, ImVec2(region_sz * zoom, region_sz * zoom), uv0, uv1, tint_col,
                     border_col);
        ImGui::EndTooltip();
      }
    }
  ...
  if (ImGui::TreeNode("Drag/Slider Flags")) {
    ...
    ImGui::SameLine();
    HelpMarker("Disable rounding underlying value to match precision of the format "
...
// natural type maximum, hence the /2.
  ...
  if (ImGui::TreeNode("Querying Item Status (Edited/Active/Hovered etc.)")) {
    ...
    ImGui::BulletText("Return value = %d\n"
                      ...
                      ImGui::IsItemClicked(), ImGui::IsItemToggledOpen(), ImGui::GetItemRectMin().x,
...
static void ShowDemoWindowLayout() {
  ...
  if (ImGui::TreeNode("Scrolling")) {
    ...
    if (show_horizontal_contents_size_demo_window) {
      ...
      HelpMarker("Test of different widgets react and impact the work rectangle "
...
static void ShowDemoWindowTables() {
  ...
  if (ImGui::TreeNode("Padding")) {
    ...
    ImGui::SameLine();
    HelpMarker("Disable inner padding between columns (double inner padding if "
  ...
  if (ImGui::TreeNode("Vertical scrolling, with clipping")) {
    HelpMarker("Here we activate ScrollY, which will create a child window container "
  ...
  if (ImGui::TreeNode("Columns widths")) {
    ...
    if (ImGui::BeginTable("table1", 3, flags1)) {
      ...
      ImGui::TableSetupColumn("three",
                              ImGuiTableColumnFlags_WidthFixed); // Default to auto
      ImGui::TableHeadersRow();
      for (int row = 0; row < 4; row++) {
        ImGui::TableNextRow();
        for (int column = 0; column < 3; column++) {
  ...
  if (ImGui::TreeNode("Advanced")) {
    ...
    if (ImGui::TreeNode("Options")) {
      ...
      if (ImGui::TreeNodeEx("Sizing:", ImGuiTreeNodeFlags_DefaultOpen)) {
        EditTableSizingFlags(&flags);
        ImGui::SameLine();
        HelpMarker("In the Advanced demo we override the policy of each column so "
        ...
        ImGui::CheckboxFlags("ImGuiTableFlags_NoClip", &flags, ImGuiTableFlags_NoClip);
        ImGui::SameLine();
        HelpMarker("Disable clipping rectangle for every individual columns (reduce "
...
void ImGui::ShowStyleEditor(ImGuiStyle *ref) {
  ...
  if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None)) {
    if (ImGui::BeginTabItem("Sizes")) {
      ...
      ImGui::SliderFloat2("SelectableTextAlign", (float *)&style.SelectableTextAlign, 0.0f, 1.0f,
                          "%.2f");
      ImGui::SameLine();
      HelpMarker("Alignment applies when a selectable is larger than its text "
                 "content.");
      ImGui::SliderFloat("SeparatorTextBorderSize", &style.SeparatorTextBorderSize, 0.0f, 10.0f,
                         "%.0f");
      ...
      ImGui::SliderFloat2("DisplaySafeAreaPadding", (float *)&style.DisplaySafeAreaPadding, 0.0f,
                          30.0f, "%.0f");
      ImGui::SameLine();
    ...
    if (ImGui::BeginTabItem("Rendering")) {
      ...
      ImGui::DragFloat("Circle Tessellation Max Error", &style.CircleTessellationMaxError, 0.005f,
                       0.10f, 5.0f, "%.2f", ImGuiSliderFlags_AlwaysClamp);
...
struct ExampleAppConsole {
  ...
  void Draw(const char *title, bool *p_open) {
    ...
    ImGui::TextWrapped("This example implements a console with basic coloring, completion "
